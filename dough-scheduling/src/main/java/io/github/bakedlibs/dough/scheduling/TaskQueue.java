...
public class TaskQueue {
    ...
    private void run(@Nonnull Plugin plugin, @Nullable TaskNode node, int index) {
        ...
        scheduleTask(plugin, node, index, runnable);
    }
    ...
    public @Nonnull TaskQueue thenRunSync(@Nonnull Runnable runnable) {
        return thenRun(runnable);
    }

    public @Nonnull TaskQueue thenRunSync(@Nonnull IntConsumer consumer) {
        return thenRun(consumer);
    }
