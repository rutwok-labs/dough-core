...
public final class PersistentDataAPI {
    ...
    public static Optional<Boolean> getOptionalBoolean(PersistentDataHolder holder, NamespacedKey key) {
        if (!hasBoolean(holder, key)) {
            return Optional.empty();
        }

        return Optional.of(getBoolean(holder, key));
    }
    ...
    public static boolean getBoolean(PersistentDataHolder holder, NamespacedKey key) {
        Byte value = holder.getPersistentDataContainer().get(key, PersistentDataType.BYTE);
    ...
    public static void removeAll(@Nonnull PersistentDataHolder holder, @Nonnull NamespacedKey... keys) {
    ...
    public static <T, Z> void copy(@Nonnull PersistentDataHolder from, @Nonnull PersistentDataHolder to, @Nonnull NamespacedKey key, @Nonnull PersistentDataType<T, Z> type) {
        Z value = from.getPersistentDataContainer().get(key, type);

        if (value != null) {
            to.getPersistentDataContainer().set(key, type, value);
        }
    }

    public static boolean hasAny(@Nonnull PersistentDataHolder holder, @Nonnull NamespacedKey... keys) {
        PersistentDataContainer pdc = holder.getPersistentDataContainer();
    ...
    public static boolean hasAll(@Nonnull PersistentDataHolder holder, @Nonnull NamespacedKey... keys) {
        PersistentDataContainer pdc = holder.getPersistentDataContainer();
