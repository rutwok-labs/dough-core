...
public class Validate {
    ...
    public static <T> T inclusiveBetween(final T start, final T end, final Comparable<T> value, final String message, final Object... values) {
    ...
    public static void inclusiveBetween(final long start, final long end, final long value, final String message) {
        // Note: primitive overload cannot return value for chaining;
        // use the generic Comparable overload if chaining is needed.
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> T exclusiveBetween(final T start, final T end, final Comparable<T> value, final String message, final Object... values) {
        if (value.compareTo(start) <= 0 || value.compareTo(end) >= 0) {
            throw new IllegalArgumentException(String.format(message, values));
        }
        return (T) value;
     ...
     */
    public static Object isInstanceOf(final Class<?> type, final Object obj, final String message, final Object... values) {
    ...
    public static void isAssignableFrom(final Class<?> superType, final Class<?> type, final String message, final Object... values) {
        // Note: returns void intentionally; use isInstanceOf for
        // return-value chaining on object instances.
